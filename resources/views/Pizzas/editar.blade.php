...
<section class="section">
    <div class="section-header text-center d-flex align-items-center justify-content-center " style="background-color: black; color: white; ">
        <h3 class="page__heading">Editar pizzas</h3>
    </div>
    <div class="card-body">
    ...
    <div>
    <form action="{{ route('Pizzas.update', $pizzas->id) }}" style="font-family: Century Gothic, sans-serif;" method="post" enctype="multipart/form-data" id="editForm">
        ...
        <div class="col-sm-12 col-lg-4 mr-auto ml-auto border p-4">
            <div class="form-group">
                ...
                <div class="custom-file container mt-3">
                    ...
                    <input type="text" class="form-control" name="nombre_pizza" value="{{ $pizzas->nombre_pizza}}">
                </div>
                ...
                <div class="custom-file container mt-2 text-center align-items-center justify-content-center">
                    <img src="/img/{{ $pizzas->imagen_pizza }}" id="imagenseleccionada" style="max-height: 100px;">
                </div>
            </div>
