                ...
                <div class="dropdown-menu">
                        ...
                        @foreach(session('carrito') as $id => $details)
                            <div class="row cart-detail">
                                <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                                    <img src="{{ asset('img') }}/{{ $details['imagen_pizza'] }}" />
                                </div>
                                <div class="col-lg-8 col-sm-8 col-8 cart-detail-product">
                                    <p>{{ $details['nombre_pizza'] }}</p>
                                    <span class="price text-info"> ${{ $details['precio_pizza'] }}</span> <span class="count"> Cantidad:{{ $details['quantity'] }}</span>
                                </div>
                            </div>
                        @endforeach
                    @endif
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-12 text-center checkout">
                            <a href="{{ route('Pizzas.carrito') }}" class="btn btn-primary btn-block">Ver todo</a>
                        </div>
                    </div>
                </div>
            </div>
