<title>Editar Postres | {{ config('app.name') }}</title>
...
<section class="section">
    <div class="section-header text-center d-flex align-items-center justify-content-center " style="background-color: black; color: white; ">
        <h3 class="page__heading">Editar postres</h3>
    </div>
    <div class="card-body">
    ...
    <div>
    <form action="{{ route('Postres.update', $postres->id) }}" style="font-family: Century Gothic, sans-serif;" method="post" enctype="multipart/form-data" id="editForm">
        ...
        <div class="col-sm-12 col-lg-4 mr-auto ml-auto border p-4">
            <div class="form-group">
                ...
                <div class="custom-file container mt-3">
                    <label style="font-family: Century Gothic, sans-serif; font-size: 14px;">Nombre postres</label>
                ...
                <div class="custom-file container mt-2 text-center align-items-center justify-content-center">
                    <img src="/img/{{ $postres->postre_imagen }}" id="imagenseleccionada" style="max-height: 100px;">
                </div>
            </div>
