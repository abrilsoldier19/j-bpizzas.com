<title>Agregar Bebidas | {{ config('app.name') }}</title>
...
<section class="section">
    <div class="section-header text-center d-flex align-items-center justify-content-center " style="background-color: black; color: white; ">
        <h3 class="page__heading">Agregar bebidas</h3>
    </div>
    <div class="card-body">
    ...
    <div>
    <form action="{{route('Bebidas.store')}}" style="font-family: Century Gothic, sans-serif;" method="post" enctype="multipart/form-data">
        ...
        <div class="col-sm-12 col-lg-4 mr-auto ml-auto border p-4">
            <div class="form-group">
                ...
                <div class="custom-file container mt-3">
                    ...
                    <input type="text" class="form-control" id="nombre_bebida" name="nombre_bebida">
                </div>
