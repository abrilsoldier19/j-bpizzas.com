                    ...
                    @foreach(session('carrito') as $id => $details)
                        ...
                        <tr data-id="{{ $id }}">
                            <td data-th="Product">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <img src="{{ asset('img') }}/{{ $details['bebida_imagen'] }}" style="max-height: 100px;" width="50" height="50" class="img-responsive" />
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="nomargin">{{ $details['nombre_bebida'] }}</p>
                                    </div>
                                </div>
                            </td>
                            <td data-th="Precio">${{ $details['bebida_precio'] }}</td>
