    ...
    <div class="row">
        ...
        <h2>Registrarse</h2>
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <label for="first_name" style="color: white;">Nombre Completo:</label><span
                ...
                <label for="email" style="color: white;">Email:</label><span
                                    class="text-danger">*</span>
                ...
                <div class="form-group">
                    <div class="d-block">
                    <label for="password" class="control-label" style="color: white;">Contraseña
                                :</label><span
                                    class="text-danger">*</span>
                    ...
                    <label for="password_confirmation"
                                   class="control-label" style="color: white;">Confirmar_Contraseña:<span
