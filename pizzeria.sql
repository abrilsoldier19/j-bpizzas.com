...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2024 at 01:01 AM
...
(7, 'Fanta Manzana', 35, 'fanta_manzana.png', 0, 3);
...
(1, 1, 1, 1, 3, '2024-02-09 02:10:47', '2024-02-09 02:10:47', 1, 1, 1);
...
(12, 'Veggie Lovers', 140, 'vegetariana.jpg', 0, 3),
(13, 'Pizza Hawaiina', 180, 'pizza_hawaiina.jpg', 1, 3),
(14, 'Meat Lovers', 200, 'meat_lovers.jpg', 0, 3),
(15, 'Pepperoni', 200, 'peperonni.jpg', 1, 3),
(16, 'Solo queso', 150, 'pizza_queso.jpg', 0, 3),
(19, 'Pizza Veggie', 140, 'vegetariana.jpg', 0, 3),
(20, 'Pizza Pastor', 209, 'pizza_pastor.jpg', 0, 33),
...
(4, 'Chocolate Icecream', 70, 'helado-chocolate-pequeno.jpg', 0, 3),
(5, 'Choco Fudge Brownie', 70, 'choco_fudge_brownie.JPG', 0, 3);
...
(2, 2, 31, 1, '2023-11-17 10:35:35', '2023-11-17 10:35:35');
...
(1, 12, 33, 1, '2023-11-17 10:34:04', '2023-11-17 10:34:04'),
...
(23, 12, 31, 2, '2024-02-14 06:24:40', '2024-02-14 06:24:40'),
(24, 12, 10, 1, '2024-02-14 07:56:50', '2024-02-14 07:56:50'),
(26, 15, 10, 0, '2024-02-15 05:38:21', '2024-02-15 05:38:21'),
...
(2, 2, 33, 1, '2023-11-17 10:35:35', '2023-11-17 10:35:35');
...
--
ALTER TABLE `pedidos`
  ADD CONSTRAINT `pedidos_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `producto_pizzas` (`id`),
  ADD CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`id_comprador`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `pedidos_ibfk_3` FOREIGN KEY (`id_bebida`) REFERENCES `producto_bebidas` (`id`),
  ADD CONSTRAINT `pedidos_ibfk_4` FOREIGN KEY (`id_postre`) REFERENCES `producto_postres` (`id`);
